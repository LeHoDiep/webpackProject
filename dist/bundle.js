            ...
            666: function (t) {
                var r = (function (t) {
                    ...
                    var v = Object.getPrototypeOf,
                        y = v && v(v(T([])));
                    y && y !== o && e.call(y, a) && (w = y);
                    var k = (h.prototype = u.prototype = Object.create(w));
                    function z(t) {
                    ...
                    function L(t, o) {
                        ...
                        return a
                            ? a.done
                                ? ((o[t.resultName] = a.value),
                                  (o.next = t.nextLoc),
                                  "return" !== o.method &&
                                      ((o.method = "next"), (o.arg = r)),
                                  (o.delegate = null),
                                  f)
                                : a
                            : ((o.method = "throw"),
                    ...
                    return (
                        ...
                        m(k, "constructor", h),
                        m(h, "constructor", x),
                        (x.displayName = m(h, l, "GeneratorFunction")),
                        ...
                        (t.AsyncIterator = j),
                        (t.async = function (r, o, e, n, a) {
                            void 0 === a && (a = Promise);
                            var i = new j(d(r, o, e, n), a);
            ...
            379: function (t) {
                ...
                function e(t, e) {
                    for (var a = {}, i = [], l = 0; l < t.length; l++) {
                        ...
                        if (-1 !== s) r[s].references++, r[s].updater(g);
                        else {
                            var b = n(g, e);
                            (e.byIndex = l),
                                r.splice(l, 0, {
                ...
                t.exports = function (t, n) {
                    ...
                    return function (t) {
                        ...
                        for (var m = e(t, n), d = 0; d < a.length; d++) {
                            var p = o(a[d]);
                            0 === r[p].references &&
    ...
    (o.m = t),
        ...
        (function () {
            ...
            function f(t, r, o, e, n, a, i) {
                ...
                l.done ? r(m) : Promise.resolve(m).then(e, n);
            }
            function u(t) {
                return function () {
                    var r = this,
            ...
            var h = o(757),
                ...
                v = (function () {
                    function t() {
                        !(function (t, r) {
                            ...
                            (this.api =
                                "https://616b970716c3fa0017171736.mockapi.io/post"),
                            (this.headers = {
                ...
                y = new v(),
                k = function () {
                    return y.readPosts().then(function (t) {
                                ...
                                (a.className =
                                    ...
                                    (a.innerHTML =
                                        "\n        <div>\n            <p><strong>"
                                            ...
                                            .concat(
                                                e,
                                                '</p>\n        </div>\n        <div>\n            <button class="btn btn-info btn-start-edit" data-id="'
                                            )
                                            .concat(
                                                r,
                ...
                z = function (t) {
                    ...
                    (o.className = "alert alert-".concat(r)),
                        (o.innerHTML = t),
                        document.querySelector("#notification").appendChild(o),
                        setTimeout(function () {
                            o.remove();
                        }, 2e3);
                },
                ...
                k(),
                    ...
                    document
                        ...
                        .addEventListener("click", function (t) {
                            var r;
                            t.target.classList.contains("btn-start-edit") &&
                                ((r = t.target.dataset.id),
                                y.readPost(r).then(function (t) {
                                    var r = t.id,
                                        o = t.title,
                                        e = t.description;
                                    (document.querySelector("#title").value =
                    ...
                    document
                        ...
                        .addEventListener("click", function (t) {
                            ...
                            var r,
                                o,
                                e = document.querySelector("#title").value,
                                n =
                                    document.querySelector(
                                        "#description"
                                    ).value;
                            (r = t.target.dataset.id),
                                (o = { title: e, description: n }),
                                y
                                    .updatePost(r, o)
                                    .then(function () {
                                        return j();
                    ...
                    document
                        ...
                        .addEventListener("click", function (t) {
                            var r;
                            t.target.classList.contains("btn-remove") &&
                                ((r = t.target.dataset.id),
                                y
                                    .deletePost(r)
                                    .then(function () {
